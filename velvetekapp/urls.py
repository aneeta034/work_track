...
urlpatterns = [
    ...
    path('delete_technician/<int:technician_id>/',views.delete_technician, name='delete_technician'),
    path('extra_work_admin/<int:service_id>/', views.extra_work_admin, name='extra_work_admin'),
